...
You should customize the messaging on the first page of your installer by updating the text in *infobefore.txt*, and replace *default.ico* with an icon that helps people deduce what your app does before calling `compile_iss`.
