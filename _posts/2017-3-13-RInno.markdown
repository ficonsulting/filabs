...
---
First, RInno ("R Inno") rhymes with minnow. The name is a combination of R and Inno Setup. If it reminds you of an odd-toed ungulate, just remember, White and Black Rhinoceros are actually both gray. One can be forgiven for calling RInno, "rhino," because the intuition is there. It's just incorrect.
