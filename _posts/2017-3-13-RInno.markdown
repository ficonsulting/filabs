...
Now, there should be a directory, `app/RInno_installer`, containing an example installer. Double-click it to see what RInno does.
...
It **was**, but [RInno][rinno] can meet those requirements because it:
