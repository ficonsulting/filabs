...
[RInno][rinno] ("R Inno" rhymes with minnow pictured above) solves this problem because it:
...
{% highlight r %}
example_app(app_dir = "app")  # Make sure to install from github for this feature
{% endhighlight %}
