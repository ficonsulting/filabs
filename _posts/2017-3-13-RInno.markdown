...
### Icons
<p>To change your app's icon, <img>src="./img/default.png"</img>, you need to copy the new icon into `app_dir` and update the file name of `app_icon = "new_app_icon.ico"`. If you also don't like our taste in setup icons, ![](/img/save.png), feel free to download your own and add `setup_icon = "new_setup_icon.ico"`.</p>
