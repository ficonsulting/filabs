...
If you are familiar with RInno, this should look almost exactly the same as compiling a shiny app installer. Hanjo has abstracted away the framework differences so that RInno supports flexdashboards behind the scenes. You don't need to change your workflow or learn too many new things to use RInno with your flexdashboards.
